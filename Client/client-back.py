...
class Client:
    ...
    def dynamic_user_loop(self):
        ...
        ## appending 'home' to list of plugins. need to do this, otherwise it's seen as an invalid diirectory
        ...
        for plugin_name in plugin_names:
            try:                
                ...
                if plugin_name[:8] == "[static]":
                    ...
                    ## add plugin directory to valid directory list
...
class DataManager:
    ...
    def __new__(cls):
        if cls._instance is None:
            ...
            #cls._instance.data = {}  # Store your shared data here
