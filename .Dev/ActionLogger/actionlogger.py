    ...
    def __new__(cls):
        with cls._lock:
            if not cls._instance:
                ...
                cls._instance.file_path = "system_log.json"  # Define the path where logs will be stored
            return cls._instance

    def log(self, request_id, response_id, action, status, details, request, response):
        """
